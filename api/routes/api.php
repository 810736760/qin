...
// Route::match(['get', 'post'], 'public/tiktok', 'PublicController@tiktok');
// Route::match(['get', 'post'], 'public/google', 'PublicController@google');
// Route::match(['get', 'post'], 'public/cookie_check', 'PublicController@cookieCheck');
