...
class SyncDayRechargeOneCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'SyncDayRechargeOneCommand {start_date?} {end_date?}';
    ...
    public function calcLinkCost($start, $end)
    {
        ...
        foreach ($data as $row) {
            if (!in_array($row['union_link_id'], $androidLink)) {
                continue;
            }
